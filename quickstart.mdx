...
- Generating JSON Without JS Rendering & Without Use Session: 0.25 credits
- API endpoint request Without JS Rendering & Without Use Session: 0.4 credits
- Generating JSON With JS Rendering & Use Session: 0.75 credits
- API endpoint request With JS Rendering & Use Session: 0.9 credits
