...
5. **Provide a Data Extraction Rule for AI**
...
6. Click "Generate JSON from webpage content"
7. Wait a few seconds while our AI analyzes the page
8. Review the generated JSON structure in the editor
...
- Generating JSON: 0.25 credits (base), 0.35 credits (with JS rendering)
