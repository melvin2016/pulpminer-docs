...
### JSON Generation
- **Cost**: 0.25 credits (Base, without JS Render)
- **Cost**: 0.35 credits (With JS Render)
- **What it does**: 
...
- **Cost**: 0.4 credits (Base, without JS Render)
- **Cost**: 0.5 credits (With JS Render)
- **What it does**:
...
```plaintext
Initial Setup:
- JSON Generation: 0.25 credits (Base, without JS Render), 0.35 credits (With JS Render)
- 100 API calls/day: 40 credits/day (without JS Render), 50 credits/day (with JS Render)
Monthly Usage: ~1,200 to 1,500 credits
```

### Multiple Endpoints
```plaintext
Initial Setup:
- 5 JSON Generations: 1.25 to 1.75 credits (depending on JS Render)
- 50 calls/day/endpoint: 20 to 25 credits/day/endpoint
Monthly Usage: ~600 to 750 credits/endpoint
```
