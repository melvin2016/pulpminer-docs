...
### JSON Generation
- **Cost**: 0.25 credits (Without JS Render & Use Session)
- **What it does**: 
...
- **Cost**: 0.4 credits (Without JS Render & Use Session)
- **What it does**:
...
```plaintext
Initial Setup:
- JSON Generation: 0.25 credits (Without JS Render & Use Session)
